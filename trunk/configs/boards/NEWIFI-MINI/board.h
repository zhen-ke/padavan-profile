...
#define BOARD_VENDOR_NAME	"Lenovo(Beijing) Technology Co. Ltd."
#define BOARD_VENDOR_URL	"http://newifi.com/"
#define BOARD_MODEL_URL		"http://newifi.com/product_newifi_mini.shtml"
